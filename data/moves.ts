...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	bulletseed: {
		...
		pp: 30,
		priority: 0,
		flags: { protect: 1, mirror: 1, metronome: 1, bullet: 1, shooting: 1 },
		multihit: [2, 5],
		secondary: null,
		target: "normal",
		type: "Grass",
	...
	doubleshock: {
		...
		pp: 5,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, light: 1, punch: 1 },
		onTryMove(pokemon, target, move) {
	...
	electroshot: {
		...
		pp: 10,
		priority: 0,
		flags: { charge: 1, protect: 1, mirror: 1, metronome: 1, light: 1 },
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	simplebeam: {
		...
		pp: 15,
		priority: 0,
		flags: { protect: 1, reflectable: 1, mirror: 1, allyanim: 1, metronome: 1, light: 1 },
		onTryHit(target) {
	...
	spark: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, light: 1 },
		secondary: {
			chance: 30,
			status: 'par',
		},
	...
	thousandarrows: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, nonsky: 1, shooting: 1  },
		onEffectiveness(typeMod, target, type, move) {
