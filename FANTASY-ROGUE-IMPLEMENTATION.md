...
更新：2026-09-21。当前交付为 200 层测试内容和基础养成，九个幻想精英池已使用用户配置，太晶权限按事件与楼层限制；战败改为治疗后继续当前场次，新增撤退与 5000 金币急救，招式使用基础 PP。其他正式阵容和经济数值后续替换。依据见 [设计文档](FANTASY-ROGUE-DESIGN.md)，来源见 [数据与许可说明](FANTASY-ROGUE-DATA.md)。
