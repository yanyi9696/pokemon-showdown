...
export declare function splitFirst(str: string, delimiter: string | RegExp): [string, string];
export declare function splitFirst(str: string, delimiter: string | RegExp, limit: 2): [string, string, string];
export declare function splitFirst(str: string, delimiter: string | RegExp, limit: 3): [string, string, string, string];
export declare function splitFirst(str: string, delimiter: string | RegExp, limit: number): string[];
/**
...
export declare function uncacheModuleTree(mod: NodeJS.Module, excludes: string[]): void;
...
export declare function bufFromHex(hex: string): Uint8Array<ArrayBuffer>;
export declare function bufWriteHex(buf: Uint8Array, hex: string, offset?: number): void;
export declare function bufReadHex(buf: Uint8Array, start?: number, end?: number): string;
...
export declare const Utils: {
    ...
    bufFromHex: typeof bufFromHex;
    bufReadHex: typeof bufReadHex;
    bufWriteHex: typeof bufWriteHex;
